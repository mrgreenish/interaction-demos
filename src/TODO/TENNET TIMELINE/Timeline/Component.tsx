...
import { useTheme } from '@components/context/ThemeContext/Component'
                  ...
                  <div className='col-span-10 lg:col-span-12'>
                    <div className='relative pt-5 pb-5 pl-10 lg:pb-10 lg:pt-2'>
                      ...
                      <div>
                        ...
                        <div className={clsx(theme.bgColor, 'progress-bar absolute top-0 lg:top-2 left-1 ml-[-1px] w-[3px] h-[calc(100%-0em)] lg:h-full -z-1 origin-top js-progress')} />
                        ...
                        <div className='absolute left-0 flex items-center justify-center w-2 h-2 border rounded-full top-5 lg:top-2 border-grey-100 bg-eggshell-100'>
                          <div className={clsx(theme.bgColor, 'w-1 h-1 rounded-full js-end-circle')} />
                        </div>
                      </div>
                    </div>
                  </div>
